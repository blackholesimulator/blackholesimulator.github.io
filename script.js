...
function setupUIEvents() {
    ...
    const handleInput = (
        ...
        document
            ...
            .addEventListener('input', (e) => {
                ...
                if (id === 'param-mass') {
                    particleSystem.material.uniforms.uMass.value =
                        val;
                }
            });
    };
    ...
    document
        .getElementById('param-suction')
        .addEventListener('input', (e) => {
            particleSystem.material.uniforms.uSuction.value =
                parseFloat(e.target.value);
    ...
    document
        .getElementById('param-stretch')
        .addEventListener('input', (e) => {
            particleSystem.material.uniforms.uStretch.value =
                parseFloat(e.target.value);
